...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.updateProfile = function (userId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var phone, firstName, lastName, bio;
                return __generator(this, function (_a) {
                    phone = data.phone, firstName = data.firstName, lastName = data.lastName, bio = data.bio;
                    // Update User (phone) and Profile (firstName, lastName, bio)
                    return [2 /*return*/, this.prisma.user.update({
                            where: { id: userId },
                            data: __assign(__assign({}, (phone && { phone: phone })), { profile: {
                                    upsert: {
                                        create: { firstName: firstName, lastName: lastName, bio: bio },
