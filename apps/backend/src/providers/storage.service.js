...
var StorageService = function () {
    ...
    var StorageService = _classThis = /** @class */ (function () {
        function StorageService_1(configService) {
            ...
            var supabaseKey = this.configService.get('SUPABASE_SERVICE_ROLE_KEY');
         ...
         */
        StorageService_1.prototype.uploadFile = function (bucket, path, file) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (error) {
                                this.logger.error("Erreur d'upload: ".concat(error.message));
                                throw new Error("Erreur lors de l'upload du fichier: ".concat(error.message));
                            }
         ...
         */
        StorageService_1.prototype.createSignedUrl = function (bucket_1, path_1) {
            return __awaiter(this, arguments, void 0, function (bucket, path, expiresIn) {
                var _a, data, error;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), data = _a.data, error = _a.error;
                            if (error) {
                                this.logger.error("Erreur cr\u00E9ation URL sign\u00E9e: ".concat(error.message));
                                throw new Error("Impossible de g\u00E9n\u00E9rer l'URL sign\u00E9e: ".concat(error.message));
                            }
