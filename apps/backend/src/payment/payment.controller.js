...
var PaymentController = function () {
    ...
    var PaymentController = _classThis = /** @class */ (function () {
         ...
         */
        PaymentController_1.prototype.initiatePayment = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.id;
                    return [2 /*return*/, this.paymentService.initiateEscrowPayment(userId, body.amount, body.provider || 'MOCK', body.orderId, body.phone)];
                });
            });
        };
        /**
         ...
         */
        PaymentController_1.prototype.handleWebhook = function (provider, payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("Received webhook from ".concat(provider, ":"), payload);
                    // TODO (Future):
         ...
         */
        PaymentController_1.prototype.releaseEscrow = function (paymentId, req) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.id;
                    return [2 /*return*/, this.paymentService.releaseEscrow(paymentId, userId)];
                });
            });
        };
    ...
    (function () {
        ...
        _initiatePayment_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('initiate')];
        _handleWebhook_decorators = [(0, common_1.Post)('webhook/:provider')];
        _releaseEscrow_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)(':id/release')];
        ...
        __esDecorate(_classThis, null, _releaseEscrow_decorators, { kind: "method", name: "releaseEscrow", static: false, private: false, access: { has: function (obj) { return "releaseEscrow" in obj; }, get: function (obj) { return obj.releaseEscrow; } }, metadata: _metadata }, null, _instanceExtraInitializers);
