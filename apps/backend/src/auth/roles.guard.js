...
var RolesGuard = function () {
    ...
    var RolesGuard = _classThis = /** @class */ (function () {
        ...
        RolesGuard_1.prototype.canActivate = function (context) {
            ...
            if (!user || !user.roles) {
                throw new common_1.ForbiddenException("Vous n'avez pas les droits nécessaires pour effectuer cette action.");
            }
            var hasRole = requiredRoles.some(function (role) { var _a; return (_a = user.roles) === null || _a === void 0 ? void 0 : _a.includes(role); });
            if (!hasRole) {
                throw new common_1.ForbiddenException("Vous n'avez pas les droits nécessaires pour effectuer cette action.");
            }
            return true;
