    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, usersService) {
            var _this = _super.call(this, {
                ...
                secretOrKey: configService.get('jwt.secret') || 'default-secret-key-change-it',
            }) || this;
        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.findByEmail(payload.email)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                throw new common_1.UnauthorizedException('Utilisateur introuvable ou token invalide');
                            }
