...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        function AuthController_1(authService, usersService) {
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Inscription d\'un nouvel utilisateur' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'Utilisateur créé, retourne le JWT.' }), (0, swagger_1.ApiResponse)({ status: 400, description: 'Données invalides.' }), (0, swagger_1.ApiResponse)({ status: 409, description: 'L\'email est déjà utilisé.' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Connexion d\'un utilisateur existant' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Connexion réussie, retourne le JWT.' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Identifiants invalides.' })];
        _getProfile_decorators = [(0, common_1.Get)('profile'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Obtenir le profil de l\'utilisateur connecté' })];
        _updateProfile_decorators = [(0, common_1.Patch)('profile'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Mettre à jour le profil de l\'utilisateur connecté' })];
