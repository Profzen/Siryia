...
var KycController = function () {
    ...
    var KycController = _classThis = /** @class */ (function () {
        ...
        KycController_1.prototype.uploadDocument = function (req, documentType, file) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (!documentType) {
                        throw new common_1.BadRequestException('documentType manquant (ID_CARD, PASSPORT, SELFIE, RCCM)');
                    }
                    userId = req.user.id;
                    return [2 /*return*/, this.kycService.uploadDocument(userId, documentType, file)];
                });
            });
        };
        KycController_1.prototype.getStatus = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.kycService.getStatus(req.user.id)];
                });
            });
        };
