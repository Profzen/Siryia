...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, documentFactory, configService, port;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    config = new swagger_1.DocumentBuilder()
                        ...
                        .addBearerAuth()
                        .build();
                    documentFactory = function () { return swagger_1.SwaggerModule.createDocument(app, config); };
                ...
                case 2:
                    _a.sent();
                    console.log("Application is running on: http://localhost:".concat(port, "/api"));
