...
var categories_controller_1 = require("./categories/categories.controller");
...
var MarketplaceModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [categories_controller_1.CategoriesController, products_controller_1.ProductsController, orders_controller_1.OrdersController],
            providers: [categories_service_1.CategoriesService, products_service_1.ProductsService, orders_service_1.OrdersService]
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var MarketplaceModule = _classThis = /** @class */ (function () {
        function MarketplaceModule_1() {
        }
        return MarketplaceModule_1;
    }());
    __setFunctionName(_classThis, "MarketplaceModule");
    (function () {
